...
<h1 class="rotItens">Últimos Itens encontrados</h1>
...
<div class="card-item2">
        ...
        <div class="item-info2">
            <h3 class="itemNome">Mouse</h3>

            <div class="info2">
            <label> <strong>Tipo de Item: </strong>Eletrônico</label>
            </div>

            <div class="info-footer2">
                <a href="index.php" class="btn-visualizar">Visualizar</a>
